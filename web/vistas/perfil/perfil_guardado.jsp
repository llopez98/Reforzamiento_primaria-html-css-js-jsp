<%-- 
    Document   : perfil_guardado
    Created on : 12/04/2021, 02:02:28 PM
    Author     : lueun
--%>


<%@page import="Entidades.Estudiante"%>
<%@page import="Procesos.CambiarDatosEstudiante"%>
    ...
    <body>
        <%
                ...
                if(request.getParameter("pass") != null){
                    CambiarDatosEstudiante cambiar = new CambiarDatosEstudiante();
                    Estudiante ez = new Estudiante();
                    
                    ez.setCorreo(request.getParameter("correo"));
                    ez.setContraseña(request.getParameter("pass"));
                    result =  cambiar.GuardarCambios(ez);
                }
            %>
        <!-- MENU -->
        ...
        <div class="container">
            ...
            window.location.href = "../../vistas/perfil/perfil.jsp";
        </script>
                          <%
                          }else{%>
                               <script>
