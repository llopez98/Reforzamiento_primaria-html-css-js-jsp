          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item text-uppercase">
                <a class="nav-link" href="vistas/dashboard/dashboard_m.jsp">Dashboard</a>
              </li>
              <li class="nav-item text-uppercase">
                <a class="nav-link" href="vistas/crud/admin_crud.jsp">Administrar</a>
              </li>
              <li class="nav-item text-uppercase">
                <a class="nav-link" href="vistas/reportes/reportes.jsp">Reportes</a>
              </li>                      
            </ul>
            ...
            <div
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item fs-4" href="vistas/perfil/perfil_docente.jsp">Perfil</a></li>
